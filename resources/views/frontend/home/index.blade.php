                        ...
                        <div class="product-default inner-quickview inner-icon">
                            <figure class="img-effect">
                                <a href="demo1-product.html">
                                    <img src="{{url('products/' . json_decode($product->images)[0])}}" width="205" height="205" alt="product">
                                </a>
                            ...
                            <div class="product-details">
                                <div class="category-wrap">
                                    <div class="category-list">
                                        <a href="demo1-shop.html" class="product-category">{{$product->category ? $product->category->name : ''}}</a>
                                    </div>
                    ...
                    <div class="side-menu-wrapper text-uppercase mb-2 d-none d-lg-block">
                        ...
                        <nav class="side-nav">
                            <ul class="menu menu-vertical sf-arrows">
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    @foreach ($category->subcategories as $subcategory)
                                                        <li><a href="{{ url('/products/all?cat_ids%5B%5D=' . $subcategory->id ) }}">{{ $subcategory->name }}</a></li>
                                ...
                                <li>
                                    <a href="#" class="sf-with-ul"><i
                                            class="sicon-star"></i>Brands</a>

                                    <ul>
                                        @foreach (App\Models\Brand::orderBy('name', 'asc')->get() as $brand)
                                            <li>
                                                <a href="{{ url('/products/all?brand_ids%5B%5D=' . $brand->id ) }}">{{ $brand->name }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </li>
